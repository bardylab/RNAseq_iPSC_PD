...
load(paste0(datadir, "/Shong_DAN_salmon_counts_unfiltered.RData"))
...
write.csv(cbind(n.expressed.hkgenes, genes_per_sample), file = paste0(resultsdir, "/iPSDopa_QCmetrics.csv"))
